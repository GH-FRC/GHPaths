...
public final class ShowCoordinator {
    ...
    public void tick() {
        ...
        telemetry.publish(xM, yM, headingRad, clock.tShowS(),
            dsPermits, moving, showState, clock.isFresh(), fault);
    }
